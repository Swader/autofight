...
/** @var int $iArmy1 */
$iArmy1 = (PHP_SAPI == 'cli') //he PHP constant PHP_SAPI has the same value as php_sapi_name() -> Returns the type of interface between web server and PHP
 ...
 * Start the war
 */
//$oWar->addArmy($oArmy1->setLabel('Tea'))->addArmy($oArmy2->setLabel('Yigit'));
